...
def create_parser():
    ...
    parser.add_argument('--ex_name', default='iam4vp', type=str)
    ...
    parser.add_argument('--data_root', default='../SimVP/data/moving_objects')
    ...
    parser.add_argument('--model_path', default='./outputs/iam4vp/checkpoint.pth', type=str)
